...
# *************************************** 0.5X模型 ****************************************
opt.cfg =[62, 62, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512, 'M', 512, 512, 512]
opt.student = True
faster_rcnn = FasterRCNNVGG16_PRUNE(cfg=opt.cfg)
print(faster_rcnn)
faster_rcnn.cuda()
H = torch.tensor(600, device='cuda')
W = torch.tensor(800, device='cuda')
...
# *************************************** 0.25X模型 ****************************************
# opt.cfg = [16, 16, 'M', 32, 32, 'M', 64, 64, 64, 'M', 128, 128, 128, 'M', 128, 128, 128]
# opt.student = True
# faster_rcnn = FasterRCNNVGG16_PRUNE(cfg=opt.cfg)
# # print(faster_rcnn)
# faster_rcnn.cuda()
