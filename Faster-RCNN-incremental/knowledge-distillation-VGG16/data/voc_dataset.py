...
VOC_BBOX_LABEL_NAMES_all = opt.VOC_BBOX_LABEL_NAMES_all
...
class VOCBboxDataset:
    ...
    * :obj:`difficult.dtype == numpy.bool`
    ...
    def __init__(self, data_dir, split=opt.datatxt,
        ...
        self.label_names = opt.VOC_BBOX_LABEL_NAMES_all # 第index+1个类（tvmonitor）
...
class VOCBboxDataset_test_all:
    ...
    def __init__(self, data_dir, split=opt.datatxt,
        ...
        self.use_difficult = use_difficult
        self.return_difficult = return_difficult
        self.label_names = opt.VOC_BBOX_LABEL_NAMES_all
